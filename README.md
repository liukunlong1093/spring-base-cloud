...
* Spring Cloud Gateway - 网关是在云平台上提供动态路由，监控，弹性，安全等边缘服务的框架。Zuul 相当于是设备和 Netflix 流应用的 Web 网站后端所有请求的前门。
...
## 应用组件
![components](/picture/components.jpg)
...
![registry](/picture/registry.jpg)
## 监控
访问 http://localhost:8040/ 默认账号 admin，密码 admin
### 控制面板
![monitor](/picture/monitor1.jpg)
### 应用注册历史
![monitor](/picture/monitor2.jpg)
### Turbine Hystrix面板
![monitor](/picture/monitor3.jpg)
### 应用信息、健康状况、垃圾回收等详情
![monitor](/picture/monitor4.jpg)
### 计数器
![monitor](/picture/monitor5.jpg)
### 查看和修改环境变量
![monitor](/picture/monitor6.jpg)
### 管理 Logback 日志级别
![monitor](/picture/monitor7.jpg)
### 查看并使用 JMX
![monitor](/picture/monitor8.jpg)
### 查看线程
![monitor](/picture/monitor9.jpg)
### 认证历史
![monitor](/picture/monitor10.jpg)
### 查看 Http 请求轨迹
![monitor](/picture/monitor11.jpg)
### Hystrix 面板
![monitor](/picture/monitor12.jpg)
## 链路跟踪
访问 http://localhost:9411/ 默认账号 admin，密码 admin
### 控制面板
![zipkin](/picture/zipkin1.jpg)
### 链路跟踪明细
![zipkin](/picture/zipkin2.jpg)
### 服务依赖关系
![zipkin](/picture/zipkin3.jpg)
## RabbitMQ 监控
Docker 启动访问 http://localhost:15673/ 默认账号 guest，密码 guest（本地 rabbit 管理系统默认端口15672）

![rabbit](/picture/rabbit.jpg)
# 接口测试
1. 获取 Token
```
